import { Controller, Get, Post, Patch, Delete, Query, Body, Param, UseGuards, BadRequestException, HttpStatus } from '@nestjs/common';
...
export class ModuleController {
  ...
  async getModulesByScope(
    ...
    const version = moduleVersion ? parseInt(moduleVersion, 10) : undefined;
    // Validate scope is valid enum value
    ...
    return this.moduleService.getModulesByScope(scope as ModuleScope, version);
  }
