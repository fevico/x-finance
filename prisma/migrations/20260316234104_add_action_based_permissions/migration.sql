-- CreateEnum
CREATE TYPE "RoleScope" AS ENUM ('GROUP', 'ENTITY');
...
-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_groupAdminRoleId_fkey" FOREIGN KEY ("groupAdminRoleId") REFERENCES "Role"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "UserRole" ADD CONSTRAINT "UserRole_entityId_fkey" FOREIGN KEY ("entityId") REFERENCES "Entity"("id") ON DELETE CASCADE ON UPDATE CASCADE;
